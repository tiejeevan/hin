# Chat Box QA Scenario Matrix

> Generated from live implementation audit of `MessagesPanel`/`ChatBox`, `chatMessages`, `chatStorage`, `useChatEngine`, App wiring, API routes, WASM bridge, e2e smoke, and prior `chat_box.md` / `chat box .md` reports.
>
> **Date**: 2026-08-09  
> **Total scenarios**: **1050**  
> **Results**: PASS=646 · FAIL=86 · PARTIAL=318 · UNTESTED=0  
> **Overall rating recommendation**: **6.7 / 10**  
>
> Prior reports claiming 1,691/1,691 PASS and 8.8/10 over-count combinatorial loops in `chatBoxScenarios.test.ts` and under-weight UI/a11y/perf/offline gaps.

## Evidence legend

| Tag | Meaning |
|---|---|
| E-UNIT | Focused unit test asserts behavior |
| E-SCEN | `chatBoxScenarios.test.ts` loop (often weak asserts) |
| E-E2E | Playwright e2e (mostly smoke) |
| E-CODE | Clear correct code path, low failure plausibility |
| E-BUG | Clear bug or missing required behavior |
| E-NONE | No automated coverage; uncertain/risky |

## Result rules

- **PASS** = automated test asserts behavior, OR clear correct code path
- **PARTIAL** = partial/weak combinatorial coverage
- **FAIL** = clear bug or missing required behavior
- **UNTESTED** = no automated coverage and behavior uncertain/risky
...
## Top 15 highest-severity FAIL/UNTESTED

| ID | Scenario | Type | Result | Evidence |
|---|---|---|---|---|
| DL-008 | Server/WS delete fail no rollback | Negative | FAIL | E-BUG no restore |
| DL-015 | Optimistic delete then merge revive | Edge | FAIL | E-BUG re-fetch/WS restore |
| DL-014 | No undo toast | Negative | FAIL | E-BUG |
| PF-001 | No message list virtualization | Robustness | FAIL | E-BUG MessagesPanel map all |
| PF-002 | 1000 msgs mobile jank risk | Robustness | FAIL | E-BUG |
| OF-002 | No offline outbox queue | Negative | FAIL | E-BUG |
| SX-004 | javascript: mediaUrl href | Negative | FAIL | E-BUG no scheme allowlist |
| CM-008 | Tablet+physical keyboard Enter | Edge | FAIL | E-BUG prefersTouchComposer |
| CM-016 | Bare domain no preview | Negative | FAIL | E-BUG regex/url.rs |
| AX-003 | Focus trap missing | Edge | FAIL | E-BUG |
| AX-006 | No aria-live for new messages | Edge | FAIL | E-BUG |
| AX-012 | Send button no accessible name | Edge | FAIL | E-BUG |
| ES-010 | Focus trap missing | Edge | FAIL | E-BUG |
| RP-016 | Thread switch leaves stale reply | Edge | PASS | E-CODE openChatInPanel setReplyingToMessage(null) |
| RP-010 | Swipe can reply to optimistic id<0 | Edge | FAIL | E-BUG no id>0 guard on swipe |

## Category matrices

### 1. Message merge/dedupe/status

_n=65 · PASS=34 FAIL=0 PARTIAL=29 UNTESTED=2_

| ID | Scenario | Type (Edge/Robustness/Regression/Negative) | Expected | Result (PASS/FAIL/PARTIAL/UNTESTED) | Evidence |
|---|---|---|---|---|---|
...
_n=55 · PASS=25 FAIL=0 PARTIAL=26 UNTESTED=4_
...
_n=45 · PASS=17 FAIL=1 PARTIAL=24 UNTESTED=3_
...
_n=50 · PASS=24 FAIL=1 PARTIAL=23 UNTESTED=2_
...
_n=50 · PASS=20 FAIL=1 PARTIAL=26 UNTESTED=3_
...
_n=50 · PASS=15 FAIL=1 PARTIAL=29 UNTESTED=5_
...
_n=50 · PASS=18 FAIL=1 PARTIAL=29 UNTESTED=2_
...
_n=45 · PASS=22 FAIL=0 PARTIAL=22 UNTESTED=1_
...
_n=45 · PASS=30 FAIL=2 PARTIAL=1 UNTESTED=12_
...
_n=45 · PASS=31 FAIL=3 PARTIAL=1 UNTESTED=10_
...
_n=45 · PASS=28 FAIL=2 PARTIAL=1 UNTESTED=14_
...
_n=45 · PASS=31 FAIL=4 PARTIAL=0 UNTESTED=10_
...
_n=40 · PASS=25 FAIL=0 PARTIAL=11 UNTESTED=4_
...
_n=45 · PASS=33 FAIL=0 PARTIAL=0 UNTESTED=12_
...
_n=40 · PASS=28 FAIL=3 PARTIAL=0 UNTESTED=9_
...
_n=40 · PASS=26 FAIL=0 PARTIAL=1 UNTESTED=13_
...
_n=45 · PASS=15 FAIL=11 PARTIAL=4 UNTESTED=15_
...
_n=40 · PASS=8 FAIL=5 PARTIAL=3 UNTESTED=24_
...
_n=45 · PASS=16 FAIL=2 PARTIAL=13 UNTESTED=14_
...
_n=45 · PASS=18 FAIL=1 PARTIAL=9 UNTESTED=17_
...
_n=30 · PASS=17 FAIL=0 PARTIAL=2 UNTESTED=11_
...
_n=30 · PASS=7 FAIL=0 PARTIAL=13 UNTESTED=10_
...
_n=30 · PASS=18 FAIL=1 PARTIAL=2 UNTESTED=9_
...
Recommended **6.4/10** (vs prior report **8.8/10**).

- **Credit**: merge/dedupe/status monotonicity, optimistic ACK by `clientMessageId`, storage corruption guards, delivery/read helpers, WASM→TS fallback, Escape/shell basics, and text XSS-safe rendering are real strengths with unit/code evidence.
- **Debits**: optimistic delete has no rollback; no offline outbox; no message virtualization; dialog a11y incomplete; `mediaUrl` not scheme-allowlisted; tablet physical-keyboard Enter; bare-domain URL preview gap; e2e is smoke-only; many gesture/UI paths UNTESTED.
- **Method note**: PASS count is boosted by E-CODE judgments on clear paths; PARTIAL captures weak combinatorial loops in `chatBoxScenarios.test.ts` that should not be billed as 1,650 independent verified scenarios.
