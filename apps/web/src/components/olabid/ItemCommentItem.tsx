...
import { PostContentText } from '../feed/PostContentText';
        ...
        <div className="flex-grow min-w-0 text-left">
              ...
              {isEditing ? (
                <div className="space-y-2 mt-1.5 relative">
                  ...
                  <div className="flex justify-end gap-1.5">
                    ...
                    <button
                      onClick={() => onSaveEdit(olabidItemId, comment.id)}
                ...
                {menuOpen && (
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() => {
                        setMenuOpen(false);
                        onDeleteComment(olabidItemId, comment.id);
                      }}
          ...
          {!isDeleted && !isEditing && !readOnly && (
            <div className="flex items-center gap-3 mt-1.5">
              <button
                type="button"
                onClick={() => onToggleCommentLike(olabidItemId, comment.id)}
              ...
              <button
                type="button"
                onClick={() => onReply(olabidItemId, comment)}
